...
(function() {
    ...
    var Overlay = function(viewer,options) {
        ...
        this.presetImageWidth = options.presetImageWidth;
        this.presetImageHeight = options.presetImageHeight;
    ...
    Overlay.prototype = {
        ...
        // ----------
        resize: function() {
            if (this.presetImageWidth && this.presetImageHeight) {
                this.imgWidth = this.presetImageWidth;
                this.imgHeight = this.presetImageHeight;
            }
            else {
